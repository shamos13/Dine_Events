  ...
  return <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(300px,0.96fr)]">
    ...
    <div className="space-y-6">
      ...
      <Panel className="border-blue-200 bg-blue-50 text-center">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">Our kitchen and logistics teams are available 24/7 for event support.</p>
        <button className="mt-5 text-sm font-semibold text-[#cc2622] hover:underline">Contact Support Center</button>
      </Panel>
    </div>
  </div>
}
