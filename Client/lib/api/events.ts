...
export type EventResponse = { eventId: number; eventName: string; guestCount: number; eventStatus: EventStatus; eventVenue: string; eventLocation: string | null; eventDateTime: string; eventEndDateTime: string | null; clientName: string | null; clientPhone: string | null; clientEmail: string | null }
