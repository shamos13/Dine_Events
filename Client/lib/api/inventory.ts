...
export type InventoryAllocationResponse = { allocationId: number; inventoryName: string; eventName: string; clientName: string | null; pricingType: PricingType; quantityAllocated: number; unitPriceAtAllocation: number | null; flatRate: number | null; totalCost: number }
